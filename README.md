...
## 🛠️ Project Infrastructure & Metadata
The following infrastructure services were successfully set up and configured for this project:

| Service | Provider | Configuration / URL | Setup Date |
| :--- | :--- | :--- | :--- |
| **Domain & DNS Hosting** | [Fasthosts](https://www.fasthosts.co.uk) | `fasthosts.co.uk` | May 17, 2026 |
| **Business Email Server** | [Fasthosts Mailbox](https://mailbox.fasthosts.co.uk) | `mailbox.fasthosts.co.uk` | May 17, 2026 |
| **Contact Form Submission** | [Web3Forms](https://web3forms.com) | `web3forms.com` API Integration | May 17, 2026 |
| **Continuous Deployment** | [Netlify](https://www.netlify.com) | Deployed via Netlify CDN | May 17, 2026 |
| **Version Control & Hosting**| [GitHub](https://github.com) | Hosted on GitHub Repository | May 17, 2026 |
